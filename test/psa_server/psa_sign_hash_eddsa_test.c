 ...
 * psa_sign_hash_with_context() with that key and the PureEdDSA algorithm
 * must return PSA_ERROR_INVALID_ARGUMENT (the hash workers only accept
 * SIGN_HASH algorithms such as Ed25519ph / Ed448ph).
 *
 * Build:
